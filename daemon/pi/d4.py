...
default_opts = {
	'config_file': '/home/pi/code/d4.cfg',
	'verbose': 0,
...
parser.add_argument( '-c', default=default_opts['config_file'], help='read from config file (default='+default_opts['config_file']+')' )
...
def log_data( humantime ):
	...
	pressure = sensor.get_pressure()   # == get_temperaure_from_humidity()
...
#   sent while main loop (outside of time.sleep) is running; e.g. USR2 arrives
...
while True:
	...
	if( (last_signal==signal.SIGUSR2) or (last_signal==signal.SIGHUP) ):
